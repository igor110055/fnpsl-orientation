<?php 
/*
 * Template Name: Template Fiche métier
 * Template Post Type: fiche-metier
 */
get_header(); 
    ...
    <section class="template_content">
        ...
        <div class="template-section template_content-formation">
            ...
            if( $featured_formations ): ?>
                ...
                wp_reset_postdata(); ?>
                <?php else: echo "Aucune formation n'est encore reseignée sur notre site, n'hésitez pas à nous contacter si vous souhaitez plus d'informations" ?>
            <?php endif; ?>
        </div><!-- /.template-section -->
